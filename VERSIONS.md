...
| `release/18-s7.9.0-h4.8.0-lts7.5.6-tft4.9.0-touch4.10.0-c3v1.1.0` | **7.9.0** | **7.5.6** | **1.1.0** | **4.8.0** | **4.9.0** | **4.10.0** | ✅ | [zip](https://github.com/kittiphun-rut/IV-Monitor-BCNPH/archive/refs/heads/release/18-s7.9.0-h4.8.0-lts7.5.6-tft4.9.0-touch4.10.0-c3v1.1.0.zip) | [`33430a2`](https://github.com/kittiphun-rut/IV-Monitor-BCNPH/tree/33430a28c45a546cca227a8c2a001b36917f677d) | **ตรวจความพร้อมก่อนผลิตจริงแล้วแก้ ๔ ข้อแรก** เตียงที่หายไปจากอากาศระหว่างให้น้ำเกลือมีเสียงเตือนแล้ว (ALERT_LOST_LINK ใช้ฝั่ง Host เท่านั้น ไม่แตะโครงสร้างแพ็กเก็ต) · จำนวนหยดสะสมรอดไฟดับด้วยการเก็บสองชั้น RTC + NVS · เปิดสุนัขเฝ้าบ้าน ๘ วินาทีทุกสาย พร้อมรายงานสาเหตุการรีบูต · แก้การนับเวลาที่พังเมื่อ millis() วนรอบ · ปฏิเสธแพ็กเก็ตที่ค่าเป็นไปไม่ได้ · รายงานฉบับเต็มที่ `docs/PRODUCTION-READINESS.md`<br><sub>23/9/2026</sub> |
| `release/19-s7.9.0-h4.8.0-c3v1.2.0` | 7.9.0 | 7.5.6 | **1.2.0** | 4.8.0 | 4.9.0 | 4.10.0 | ✅ | [zip](https://github.com/kittiphun-rut/IV-Monitor-BCNPH/archive/refs/heads/release/19-s7.9.0-h4.8.0-c3v1.2.0.zip) | [`5513859`](https://github.com/kittiphun-rut/IV-Monitor-BCNPH/tree/5513859e78979acd1b36ab3915305cad468ddde2) | **ตัวช่วยคาลิเบรตสี่ขั้นตอนที่หน้าเครื่องของสายบอร์ดเล็ก** BASELINE · DIRECTION · LEARN · VERIFY ผ่านครบจึงบันทึกลง NVS เปิดเครื่องครั้งหน้าพร้อมนับทันที · ขั้นหาทิศวัดค่าดิบเอง เพราะกลไกลองผิดลองถูกของตัวตรวจจับล็อกทิศผิดเมื่ออัตราไหลทำให้ใช้เวลาเกิน ๑๐ วินาที ทำให้ SNR ตกครึ่งหนึ่ง · ระหว่างคาลิเบรตรายงาน Host ว่าไม่ได้นับอยู่ กันเสียงเตือนสายพับปลอม<br><sub>24/9/2026</sub> |
