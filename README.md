...
| ที่อยู่ | คำอธิบาย |
|---|---|
| `firmware/ESP32-S3-Station-V_7_5_1/` | **เฟิร์มแวร์เครื่องประจำเตียงที่ใช้งานอยู่** — เซ็นเซอร์ IR อนาล็อก แต่รื้อระบบคัดกรองหยดใหม่ (แก้อาการนับเบิ้ล) และหน้าคาลิเบรต 3 ขั้นพร้อมจอคลื่นและค่า SNR |
...
| `tools/station-preview/` | เรนเดอร์ภาพทุกหน้าจอของเฟิร์มแวร์ Station v7.5.1 บน PC (มีเซนเซอร์จำลองสำหรับเดินหน้าคาลิเบรต) |
...
| `docs/screens-station/` | ภาพหน้าจอจริงของ Station v7.5.1 ทุกหน้า รวมหน้าคาลิเบรต |
