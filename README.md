...
| ที่อยู่ | คำอธิบาย |
|---|---|
| `firmware/ESP32-S3-Station-V_7_6_0/` | **เฟิร์มแวร์เครื่องประจำเตียงรุ่นล่าสุด** — เซ็นเซอร์หยดแบบเอาต์พุตดิจิทัล (นับด้วย interrupt), ผังขาใหม่ DO=5 / Buzzer=6 / ปุ่ม=7, หน้าทดสอบเซ็นเซอร์ |
| `firmware/ESP32-S3-Station-V_7_5_0/` | เฟิร์มแวร์เครื่องประจำเตียงรุ่นเซ็นเซอร์อนาล็อก — แนวทาง IV BAG, 4 หน้า, กราฟแนวโน้ม 30 นาที |
...
| `tools/station-preview/` | เรนเดอร์ภาพทุกหน้าจอของเฟิร์มแวร์ Station v7.6.0 บน PC |
...
| `docs/screens-station/` | ภาพหน้าจอจริงของ Station v7.6.0 ทุกหน้า |
