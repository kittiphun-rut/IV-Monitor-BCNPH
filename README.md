...
| ที่อยู่ | คำอธิบาย |
|---|---|
| `firmware/ESP32-S3-Station-V_7_7_1/` | **เฟิร์มแวร์เครื่องประจำเตียงรุ่นล่าสุด** — เหมือน v7.7.0 ทุกอย่าง และ **หมุนจอ 180 องศาได้ที่หน้าเครื่อง** เพื่อให้ติดตั้งกล่องได้ทุกทิศทาง |
...
| `firmware/ESP32-S3-Station-V_7_5_2/` | **สายเสถียร** — เหมือน v7.5.1 (คาลิเบรต 3 ขั้นแบบทำเอง) และ **หมุนจอ 180 องศาได้ที่หน้าเครื่อง** |
...
| `firmware/ESP32-S3-Host-OLED-V_4_7_2/` | **เฟิร์มแวร์ Host จอ OLED รุ่นล่าสุด** — ปรับหน้าเว็บ Dashboard: กรอบเขียวเมื่อปกติ, บอกปริมาณคงเหลือ, แถบแจ้งสถานะรวม, เสียงเตือนชัดขึ้น |
...
| `tools/station-preview/` | เรนเดอร์ภาพทุกหน้าจอของเฟิร์มแวร์ Station v7.7.1 บน PC (มีเซนเซอร์จำลองในตัว) |
...
| `docs/screens-station/` | ภาพหน้าจอจริงของ Station v7.7.1 ทุกหน้า + ภาพเปรียบเทียบจอหมุน 180 องศา |
