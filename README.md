...
| `firmware/ESP32-S3-Host-OLED-V_4_7_1/` | **เฟิร์มแวร์ Host จอ OLED 1.3" รุ่นล่าสุด** — ใช้กับ Station v7.4.x/v7.5.x/v7.7.x ได้ทุกรุ่น เพิ่มการเตือน "เซนเซอร์ยังไม่จับหยด" |
