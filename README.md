...
| `docs/คู่มือพยาบาล_Smart_IV_Alert.docx` | **คู่มือการปฏิบัติงานสำหรับพยาบาลวิชาชีพ** ตามรูปแบบเอกสารราชการไทย ๓๙ หน้า (ปก คำนำ สารบัญ ๖ บท ภาคผนวก ๕ ภาค) |
| `docs/คู่มือพยาบาล_Smart_IV_Alert_ตัวอย่าง.pdf` | ตัวอย่าง PDF ของคู่มือ (เรนเดอร์ด้วยฟอนต์แทน ไม่ใช่ TH SarabunPSK) |
| `tools/manual-build/` | **สคริปต์สร้างคู่มือ .docx** ทำสองรอบเพื่อให้เลขหน้าในสารบัญตรงกับเล่มจริง |
