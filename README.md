...
| `firmware/ESP32-S3-Host-Touch-V_4_9_0/` | **เฟิร์มแวร์ Host จอสัมผัส 2.4"** — ใช้งานเหมือนสมาร์ตโฟน ตั้งค่าได้บนจอ + ปุ่ม multifunction 1 ปุ่ม |
...
| `docs/screens-touch/` | ภาพหน้าจอจริงของ Host v4.9.0-TOUCH ทุกหน้า |
