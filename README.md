...
| `firmware/ESP32-S3-Host-OLED-V_4_7_3/` | **เฟิร์มแวร์ศูนย์กลางจอ OLED รุ่นล่าสุด** — แก้อาการ Host ขึ้น OFFLINE เมื่อมีหลายเตียง, วัดคุณภาพลิงก์, และ **แอนิเมชันหยดน้ำเกลือของทุกเตียงบนจอ** |
...
| `tools/oled-preview/` | **จำลองหน้าจอ OLED 128x64 ของ Host v4.7.3 บน PC** เรนเดอร์ออกมาเป็นภาพทุกหน้า รวมเฟรมแอนิเมชันหยด |
...
| `docs/screens-oled/` | ภาพจำลองหน้าจอ OLED ของ Host v4.7.3-OLED ทุกหน้า + เฟรมแอนิเมชันหยด |
