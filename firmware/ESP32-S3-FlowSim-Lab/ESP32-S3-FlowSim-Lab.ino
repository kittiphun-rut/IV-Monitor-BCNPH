/**
 * ============================================================================
 * โครงการวิจัย: นวัตกรรม Smart IV Alert
 ...
 *
 * ระบบ: FLOW SIMULATION & SENSOR LAB (เครื่องมือทดลอง/สาธิตเฉพาะเครื่องเดียว)
 * เวอร์ชัน: S1.0.0  (ดัดแปลงจาก Bed Station v7.3.0)
 * บอร์ด: ESP32-S3 Super Mini + TFT 1.47" (ST7789 SPI 172x320) + Passive Buzzer
