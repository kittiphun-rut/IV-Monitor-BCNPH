# เครื่องส่วนกลาง จอสัมผัส 2.4" v4.9.3 — แยกโค้ดวาดจอออกเป็น `HostScreen.h`
...
```
ย้ายออกไป 503 บรรทัด    ไฟล์หลักเหลือ 2582 บรรทัด
```
...
ได้ผลว่าเหมือนกันทุกจุดครบทั้ง **12 ภาพ**
...
ต่อยอดจาก **Host จอสัมผัส 2.4" v4.9.0** โดยนำคุณสมบัติและการแก้บั๊กทั้งหมด
...
ต่อยอดจาก **Host จอ TFT 2.8" v4.8.0** โดยเปลี่ยนเป็น **จอสัมผัส 2.4" แนวตั้ง 240x320**
