/**
 * @file      HostScreen.h
 * @brief     ทุกอย่างที่วาดลงจอสัมผัส 2.4 นิ้ว ของเครื่องส่วนกลาง
 * @version   4.9.3
 * @date      2026-09-23
 ...
 *
 * @par Description
 * แยกออกมาจาก `Host-Touch24.ino` เพื่อให้ไฟล์หลักสั้นและหาของเจอเร็วขึ้น
 * มีหน้ารวม หน้ารายเตียง หน้าตั้งค่า แป้นตัวเลข หน้าระบบ และหน้าคาลิเบรตจอสัมผัส
 *
 * @par Revision History
 * | Version | Date | Change |
 * |---|---|---|
 * | 4.9.3 | 2026-09-23 | แยกออกมาจากไฟล์หลัก ย้ายที่อยู่ล้วน ๆ ไม่ได้แก้เนื้อในแม้แต่บรรทัดเดียว |
 *
