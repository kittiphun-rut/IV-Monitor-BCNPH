 ...
 *
 * @par Description
 * แยกออกมาจาก `Station-Stable.ino` เพื่อให้ไฟล์หลักสั้นและหาของเจอเร็วขึ้น
 * เนื้อหาเหมือนของสายหลัก ต่างกันที่หน้าคาลิเบรตแบบทำเอง 3 ขั้น
 *
 * @par Revision History
 * | Version | Date | Change |
 * |---|---|---|
 * | 7.5.5 | 2026-09-23 | แยกออกมาจากไฟล์หลัก ย้ายที่อยู่ล้วน ๆ ไม่ได้แก้เนื้อในแม้แต่บรรทัดเดียว |
 *
