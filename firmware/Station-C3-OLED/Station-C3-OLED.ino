 ...
 *
 * ระบบ: Bed Station Node รุ่นบอร์ดเล็ก (เครื่องประจำเตียง)
 * เวอร์ชัน: 1.0.0-C3 (Protocol v3 — ใช้คู่กับ Host 4.7.x / 4.8.x / 4.9.x)
 * บอร์ดประมวลผล: ESP32-C3 Super Mini + จอ OLED 0.42" SSD1306 72x40
 *
