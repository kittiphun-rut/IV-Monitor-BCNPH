...
**แก้แล้วในเวอร์ชันนี้** — เส้นฐานไล่ตามการดริฟต์ทั้งในเฟส `WATCH` และ `SETTLE`
(หยุดเฉพาะตอน `PULSE`) และถ้าค้างที่ `SETTLE` เกิน 300 ms จะยึดระดับปัจจุบันเป็นเส้นฐานใหม่
แล้วกลับไปเฝ้าตามปกติ โดยนับจำนวนครั้งไว้ในช่อง `RE`
