...
ต่อยอดจาก `ESP32-S3-Station-V_7_5_3` โดยแก้อย่างเดียวคือ **วิธีคำนวณอัตราการไหล**
...
ต่อยอดจาก `ESP32-S3-Station-V_7_5_2` โดยแก้อย่างเดียวคือ **จังหวะการส่งข้อมูลให้ Host**
ส่วนอื่นทั้งหมด (การตรวจจับหยด หน้าจอ การหมุนจอ เสียงเตือน) ไม่เปลี่ยนแม้แต่บรรทัดเดียว

ต่อยอดจาก `ESP32-S3-Station-V_7_5_1` โดยเพิ่มอย่างเดียวคือ **การหมุนจอ 180 องศา**
(พอร์ตมาจาก v7.7.1) ระบบคัดกรองหยดและหน้าคาลิเบรตของ v7.5.1 ไม่เปลี่ยนแม้แต่บรรทัดเดียว

ตัวสายสัญญาณต่อยอดจาก `ESP32-S3-Station-V_7_5_0` โดย **เปลี่ยนเฉพาะวิธีตรวจจับหยดและหน้าคาลิเบรต**
...
แนะนำให้อัปเดต Host เป็น [`v4.7.3-OLED`](../ESP32-S3-Host-OLED-V_4_7_3/README.md) ด้วย
