 ...
 * ข้อความบนหน้าเว็บเป็นภาษาไทย ต่างจากข้อความบนจอที่ต้องเป็น ASCII
 *
 ...
 *
 * @note     ไฟล์นี้ค้างอยู่ที่ 4.7.6 ขณะที่สเก็ตช์เป็น 4.7.7 เพราะรุ่น 4.7.7 แยกแต่โค้ดวาดจอ
 *           ไม่ได้แตะหน้าเว็บเลย การไล่ขยับเลขทุกไฟล์ให้เท่ากันจะทำให้ตารางโกหก
 *
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Sarabun", sans-serif; }
    ...
    /* แถบวินิจฉัยการเชื่อมต่อ: ใช้ตอนที่ "Host มองไม่เห็นเตียง" ซึ่งไม่ใช่เหตุทางคลินิก */
    .diag-banner {
      display: none;
      background: #1a202c;
    ...
    .diag-banner .dg-title { font-size: 17px; font-weight: 800; color: #f6ad55; margin-bottom: 6px; }
    .diag-banner code { background: rgba(255,255,255,.12); padding: 1px 7px; border-radius: 5px; }
...
<body>
  ...
  <script>
    ...
    function renderStations(stationsData) {
      ...
      // แถบวินิจฉัย: อธิบายกรณีที่ Host ขึ้น OFFLINE ทั้งที่เครื่องข้างเตียงทำงานปกติ
